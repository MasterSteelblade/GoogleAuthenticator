...
namespace Steelblade\GoogleAuthenticator\tests;

use Steelblade\GoogleAuthenticator\GoogleAuthenticator;

class GoogleAuthenticatorTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var \Steelblade\GoogleAuthenticator\GoogleAuthenticator
     */
    protected $helper;
    ...
    /**
     * @group legacy
     * @expectedDeprecation Using Steelblade\GoogleAuthenticator\GoogleAuthenticator::getUrl() is deprecated as of 2.1 and will be removed in 3.0. Use Steelblade\GoogleAuthenticator\GoogleQrUrl::generate() instead.
     */
